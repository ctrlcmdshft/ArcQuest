    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <footer className="bg-black/40 border-t border-gray-700 py-6 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-400 text-sm">
          <p>ARC Raiders Quest Tracker • {totalQuests} Total Quests</p>
          <p className="mt-2">Data source: <a href="https://patchcrazy.co.uk/all-arc-raiders-quest-list-rewards-objectives-and-locations/" className="text-orange-400 hover:text-orange-300" target="_blank" rel="noopener noreferrer">PatchCrazy.co.uk</a></p>
        </div>
      </footer>
    </div>
  );
